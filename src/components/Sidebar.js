...
const Sidebar = () => {
    ...
    return (
        <div className="relative h-full">
            ...
            <div
                className={`fixed lg:relative w-64 h-full bg-white p-4 transform transition-transform duration-300 ease-in-out z-20 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                    } lg:translate-x-0`}
            >
                <div className="flex items-center mb-6">
                    <img src="assets/images/vector.png" alt="Quyl Logo"  />
                ...
                <ul className="py-3">
                    {menuItems.map((item) => (
                        <li
                            ...
                            className={`py-2 px-4 flex items-center rounded cursor-pointer text-lg my-2 ${selected === item.name
                                ? "text-black font-bold bg-gray-300"
                                : "text-gray-600 hover:bg-gray-200"
                                }`}
                        >
                            {item.icon}
                            <span className={`ml-3 ${selected === item.name ? "text-black" : "text-gray-600"}`}>
                                {item.name}
                            </span>
                        </li>
                    ))}
